...
public class MuxStatement implements Statement {
    ...
    protected void init(MuxConnection connection) {
        ...
        this.schema = connection.getInternal().getCurrentSchema();
    }
    ...
    public ResultSet executeQuery(String sql) throws SQLException {
        synchronized (this) {
            Map<Integer, Tuple2<String, PreparedStatementMethodInvocation>> analyzedResult = analyzer.analyze(schema, sql, null, shardOps);
